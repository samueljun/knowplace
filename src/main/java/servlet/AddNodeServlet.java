...
*/
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action.equals("addNode")) {
			...
			String input_pin_type = request.getParameter("pin_type"); // Change front end
			...
			try {
				...
				stmt.execute("INSERT INTO public.pins (pin_id, name, type, nodes_node_id) VALUES (" + String.valueOf(pin_id) + ", '" + input_pin_name + "', '" + input_pin_type +  "', " + String.valueOf(curr_node_id)  +  ")");
