...
CREATE INDEX idx_hubs ON public.hubs (users_user_i);
...
CREATE INDEX idx_nodes ON public.nodes (hubs_hub_i);
...
CREATE INDEX idx_pins ON public.pins (nodes_node_i);
...
CREATE INDEX idx_permissions ON public.permissions (pins_pin_i);
...
CREATE INDEX idx_tags ON public.tags (pins_pin_i);
